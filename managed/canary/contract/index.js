...
const _descriptor_5 = new __compactRuntime.CompactTypeBytes(15);
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.wellbeingScore) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named wellbeingScore');
    }
    ...
    this.circuits = {
      ...
      isAlert(context, ...args_1) {
        return { result: pureCircuits.isAlert(...args_1), context };
      },
      checkIn: (...args_1) => {
        if (args_1.length !== 1) {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkIn',
                                     ...
                                     'canary.compact line 108 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      closeRound: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('closeRound',
                                     'argument 1 (as invoked from Typescript)',
                                     'canary.compact line 130 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(tmp_1),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_2 = this._deriveAdmin_0(this._localSecretKey_0(context,
                                                             partialProofData));
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
  ...
  _wellbeingScore_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.wellbeingScore(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 255n)) {
      __compactRuntime.typeError('wellbeingScore',
                                 'return value',
                                 'canary.compact line 75 char 1',
                                 'Uint<0..256>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _deriveAdmin_0(sk_0) {
    return this._persistentHash_0([new Uint8Array([99, 97, 110, 97, 114, 121, 58, 97, 100, 109, 105, 110, 58, 118, 49]),
                                   sk_0]);
  }
  _nullifier_0(sk_0, r_0) {
    return this._persistentHash_1([new Uint8Array([99, 97, 110, 97, 114, 121, 58, 110, 117, 108, 58, 118, 49]),
                                   r_0,
                                   sk_0]);
  }
  _isAlert_0(score_0, threshold_0) { return score_0 <= threshold_0; }
  _checkIn_0(context, partialProofData) {
    const sk_0 = this._localSecretKey_0(context, partialProofData);
    const score_0 = this._wellbeingScore_0(context, partialProofData);
    ...
    const nul_0 = this._nullifier_0(sk_0,
                                    __compactRuntime.convertFieldToBytes(32,
                                                                         ...
                                                                         'canary.compact line 118 char 38'));
...
const _dummyContract = new Contract({
  localSecretKey: (...args) => undefined, wellbeingScore: (...args) => undefined
});
  ...
  deriveAdmin: (...args_0) => {
    ...
    if (!(sk_0.buffer instanceof ArrayBuffer && sk_0.BYTES_PER_ELEMENT === 1 && sk_0.length === 32)) {
      __compactRuntime.typeError('deriveAdmin',
                                 'argument 1',
                                 'canary.compact line 89 char 1',
                                 'Bytes<32>',
                                 sk_0)
    }
    return _dummyContract._deriveAdmin_0(sk_0);
  },
  nullifier: (...args_0) => {
    if (args_0.length !== 2) {
    ...
    return _dummyContract._nullifier_0(sk_0, r_0);
  },
  isAlert: (...args_0) => {
    if (args_0.length !== 2) {
      throw new __compactRuntime.CompactError(`isAlert: expected 2 arguments (as invoked from Typescript), received ${args_0.length}`);
    }
    const score_0 = args_0[0];
    const threshold_0 = args_0[1];
    if (!(typeof(score_0) === 'bigint' && score_0 >= 0n && score_0 <= 255n)) {
      __compactRuntime.typeError('isAlert',
                                 'argument 1',
                                 'canary.compact line 102 char 1',
                                 'Uint<0..256>',
                                 score_0)
    }
    ...
    return _dummyContract._isAlert_0(score_0, threshold_0);
  }
};
